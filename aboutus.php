    ...
    <div class="container-fluid-max">
        <header class="d-flex flex-wrap justify-content-center">
            ...
            <ul class="nav nav-pills">
                <li class="nav-item"><a href="#" class=" text-dark fw-bold visit-website">Visit website <i
                            class="bi bi-box-arrow-up-right"></i></a></li>&nbsp;&nbsp;&nbsp;
                <li class="nav-item"><a href="#" class="btn-link-success">Pitch your Project</a></li>
            </ul>
        </header>
    </div>
            ...
            <div class="col-xl-3 col-md-5 d-flex" data-aos="fade-up" data-aos-delay="100">
                <div class="member">
                    ...
                    <div class="social">
                        ...
                        <a href="https://www.facebook.com/prakashZip"><i class="bi bi-facebook"></i></a>
                        <a href="https://github.com/prakashZip"><i class="bi bi-github"></i></a>
                        <a href="https://www.instagram.com/prakashzip_/"><i class="bi bi-instagram"></i></a>
                    </div>
                </div>
            </div>
