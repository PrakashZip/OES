  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Satya Prakash" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://satyaprakash.me" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find Website">Satya Prakash</a>
		...
		<h4 style="font-family:'typo' ">Lovely professional University, Pagwara</h4></div></div>
		</p>
      </div>
